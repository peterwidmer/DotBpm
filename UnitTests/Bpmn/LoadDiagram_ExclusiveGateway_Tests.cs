...
namespace UnitTests.Bpmn
{
    ...
    public class LoadDiagram_ExclusiveGateway_Tests
    {
        ...
        {
            var process = BpmnDiagram_TestHelper.LoadDiagram("UnitTests.Bpmn.diagram_exclusivegateway.bpmn");

            var exclusiveGateway1 = (BpmnExclusiveGateway)process.Artifacts.FirstOrDefault(t => t.Id == "exclusive_gateway_1");
            ...
            var seq_parallelgateway_1_test_task_2 = (BpmnSequenceFlow)process.Artifacts.FirstOrDefault(t => t.Id == "seq_parallelgateway_1_test_task_2");
